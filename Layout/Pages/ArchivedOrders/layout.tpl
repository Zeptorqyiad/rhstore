...
)->andWhere('status in (\'canceled\', \'finished\')')->orderBy($sort);
...
App\Layout\Components\HeaderBlock\Header\Layout::draw(); ?>
    ...
    <main class="archived-orders">
        <div class="archived-orders__back">
            <div class="archived-orders__wrap">
                <?php
                App\Layout\Components\Common\NavAside\Layout::draw([
                    'class_name' => 'archived-orders__aside',
                    'active' => '3'
                ]); ?>

                <div class="archived-orders__column">
                    <?php
                    App\Layout\Components\Common\BreadCrumbs\Layout::draw([
                        'class_name' => 'archived-orders__breadcrumbs',
                        'text' => 'Архивные заказы'
                    ]);
                    ?>

                    <div class="archived-orders__top">
                        <h1 class="archived-orders__title">Архивные заказы</h1>
                    ...
                    if ($orders): ?>
                        <?php
                        App\Layout\Components\AccountBlocks\ArchivedOrders\ArchivedBadges\Layout::draw([
                            'class_name' => 'archived-orders__badges',
                            'y' => $data['y'],
                        ]); ?>
                    <?php
                    endif; ?>
                    ...
                    App\Layout\Components\Common\OrderCards\Layout::draw([
                        'class_name' => 'archived-orders__cards',
