...
<div class="<?= $data["class_name"] ?> modal-property-about modal-property" data-modal="modal-property-about">
    <div class="modal-property__wrap">
        <div class="modal-property__top">
            <button class="modal-property__btn-back modal-property__btn" data-close="modal-property-about">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M15 6L9 12L15 18" stroke="#404040" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </button>
            <button class="modal-property__btn-close modal-property__btn" data-close="modal-property-about">
                    <svg class="btn__icon btn__icon_center" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <div class="modal-property__body">
            <h4 class="modal-property__title">О товаре</h4>
            <p class="modal-property__content"><?= $p->about ?></p>
        </div>
    </div>
