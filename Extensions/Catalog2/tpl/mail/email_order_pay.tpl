    ...
    <table cellpadding="0"
        ...
        <tr>
            <td>
                                        ...
                                        font-weight: 700;
                                        line-height: 150%;
                                        color: #0D0D0D;">Заказ №<?= $order->order_id ?> оформлен</span>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <p style="font-family: 'Raleway', Arial, sans-serif;
                                            ...
                                            margin: 0;
                                            margin-bottom: 24px;">
                    Спасибо, что оформили заказ в нашем интернет-магазине. При изменении статуса заказа, мы
                    пришлём вам соответствующее сообщение.</p>
            </td>
        </tr>
    </table>
